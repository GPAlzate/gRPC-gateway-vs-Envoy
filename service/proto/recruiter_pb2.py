...
_RECRUITER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\016\"\t/register:\001*\222AN\022\rSummary: test\032\020Description TestJ+\n\003200\022$\n\032Overwrites the defined 200\022\006\n\004\232\002\001\007'),
  ),
  _descriptor.MethodDescriptor(
    name='ReadCompany',
